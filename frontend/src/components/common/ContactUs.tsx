      ...
      <div className="max-w-7xl mx-auto bg-[#444444] rounded-2xl p-6 md:p-8 shadow-xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-[#f5f5f5]">
                    Suite 756 031 Ines Riverway,<br />
                    Rhiannonchester
                  </p>
                </div>
              </div>
          ...
          <div className="bg-[#383838] rounded-xl p-6 border-2 border-[#323232]">
            <h3 className="text-[#EDEDED] text-2xl font-semibold mb-6">
              Get in Touch
            </h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <input
                  ...
                  onChange={handleChange}
                   className="w-full bg-transparent text-white px-4 py-3 rounded-lg border-b-2 border-[#f5f5f5] focus:border-[var(--green)] focus:outline-none focus:ring-0 transition-colors"
                />
                <input
                  type="email"
                  name="email"
              ...
              <button
                type="submit"
                className="w-full bg-[var(--green)] text-white py-3 rounded-lg font-semibold hover:bg-[#9CCF03] transition-colors focus:outline-none focus:ring-2 focus:ring-[var(--green)] focus:ring-offset-2 focus:ring-offset-[#333333]"
              >
                Submit
              </button>
            </form>
