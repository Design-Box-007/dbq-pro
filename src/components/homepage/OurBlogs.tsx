    ...
    <div className="w-full  py-6 px-4 sm:px-6 lg:px-10">
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          ...
          <Link href="/blog" className="w-auto px-4 py-2.5 rounded-xl bg-[var(--green)] text-white hover:text-black hover:bg-white transition-all duration-300 flex items-center justify-start group">
